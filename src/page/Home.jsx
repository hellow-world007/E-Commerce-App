      ...
      >
        <div key={id} className="glass-item">
          ...
          <div className="title-category">
            <p className="img-title">{name}</p>
            <p className="img-category">{category}</p>
          </div>
        </div>
      </Link>
    );
    ...
    <div className="home-container">
      <div className="home-representative">
        ...
        <p className="description">
          Lorem ipsum dolor sit amet consectetur <br /> adipisicing elit. Omnis
          voluptatibus <br /> id quidem esse voluptatum sit mollitia ut <br />
          libero repudiandae soluta.
        </p>
      ...
      <div className="featured-products">
        <div className="featured-header">
          ...
          <Link className="all-featured-items" to="/featured">
            See All
          </Link>
        </div>

        <div className="featured-items">{glassElements}</div>
      </div>

      <div className="recommended-products">
        <div className="recommended-header">
          <p className="products-title">Recommended Products</p>
          <Link className="all-recommended-items" to="/recommended">
            See All
          </Link>
        </div>

        <div className="recommended-items">{recommendedElements}</div>
      </div>
